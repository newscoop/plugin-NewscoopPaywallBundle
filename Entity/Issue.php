...
class Issue
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Newscoop\PaywallBundle\Entity\UserSubscription", inversedBy="sections")
     * @ORM\JoinColumn(name="IdSubscription", referencedColumnName="Id")
     * @var Newscoop\PaywallBundle\Entity\UserSubscription
     */
    ...
    /**
     * @param Newscoop\PaywallBundle\Entity\UserSubscription $subscription
     * @param IssueEntity                                    $issue
     */
    public function __construct(UserSubscription $subscription, IssueEntity $issue)
    {
     ...
     * Get subscription
     *
     * @return Newscoop\PaywallBundle\Entity\UserSubscription
     */
